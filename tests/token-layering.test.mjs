...
const LOAD_ORDER = [
  ...
  'dim-sum.css', 'comfort.css', 'about.css', 'notifications.css', 'command-palette.css', 'catch-vehicle.css', 'appearance.css', 'scheduled-settings.css', 'tab-strip.css', 'shell.css',
];
