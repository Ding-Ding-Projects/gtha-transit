...
const expectedSourceIds = new Set(["ttc-washrooms", "go-union-facilities", "go-usbt", "up-union-facilities", "metrolinx-gtfs", "yrt-facilities", "miway-city-centre", "hsr-customer-service", "tpl-toronto-reference-library", "tpl-high-park", "tpl-branch-general-information-4326", "tpl-scarborough-civic-centre-record", "tpl-north-york-central-record", "tpl-eatonville-record", "tpl-richview-record", "tpl-fort-york-record", "tpl-parliament-street-record", "tpl-lillian-h-smith-record"]);
const expectedFacilityIds = new Set(["ttc-bloor-yonge", "ttc-eglinton", "ttc-finch", "ttc-sheppard-yonge", "ttc-sheppard-west", "ttc-vaughan-metropolitan-centre", "ttc-wilson", "ttc-finch-west", "ttc-kennedy", "ttc-kipling", "ttc-don-mills", "ttc-mount-dennis", "ttc-cedarvale", "ttc-humber-college", "go-union-station", "go-union-station-bus-terminal", "up-union-station", "yrt-newmarket-terminal", "yrt-pioneer-village-terminal", "yrt-richmond-hill-centre-terminal", "yrt-smartvmc-bus-terminal", "miway-city-centre-transit-terminal", "hsr-frank-a-cooke-transit-terminal", "toronto-library-toronto-reference-library", "toronto-library-high-park", "toronto-library-scarborough-civic-centre", "toronto-library-north-york-central", "toronto-library-eatonville", "toronto-library-richview", "toronto-library-fort-york", "toronto-library-parliament-street", "toronto-library-lillian-h-smith"]);
const expectedCoordinateRecords = new Map([
  ...
  ["toronto-library-scarborough-civic-centre", { lat: 43.77237, lon: -79.25704, receipt: "tpl-scarborough-civic-centre-record", reference: "Toronto Public Library BranchCode=SC, _id=93" }],
  ["toronto-library-north-york-central", { lat: 43.76817, lon: -79.41451, receipt: "tpl-north-york-central-record", reference: "Toronto Public Library BranchCode=CL, _id=24" }],
  ["toronto-library-eatonville", { lat: 43.64616, lon: -79.5591, receipt: "tpl-eatonville-record", reference: "Toronto Public Library BranchCode=EA, _id=35" }],
  ["toronto-library-richview", { lat: 43.68344, lon: -79.54113, receipt: "tpl-richview-record", reference: "Toronto Public Library BranchCode=RI, _id=88" }],
  ["toronto-library-fort-york", { lat: 43.63923, lon: -79.40039, receipt: "tpl-fort-york-record", reference: "Toronto Public Library BranchCode=FO, _id=41" }],
  ["toronto-library-parliament-street", { lat: 43.66183, lon: -79.36803, receipt: "tpl-parliament-street-record", reference: "Toronto Public Library BranchCode=PL, _id=81" }],
  ["toronto-library-lillian-h-smith", { lat: 43.65798, lon: -79.39839, receipt: "tpl-lillian-h-smith-record", reference: "Toronto Public Library BranchCode=LS, _id=63" }]
]);
...
test("washroom registry has source receipts and conservative hours metadata", async () => {
  ...
  for (const facility of registry.facilities) {
    ...
    assert.equal(typeof facility.sourceHoursURL, "string");
    assert.ok(isTimestamp(facility.hoursRetrievedAt));
    assert.equal(new URL(facility.sourceHoursURL).protocol, "https:");
    assert.ok(officialHosts.has(new URL(facility.sourceHoursURL).hostname));
