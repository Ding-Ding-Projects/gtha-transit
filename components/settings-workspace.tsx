...
export default function SettingsWorkspace({ appearance, lang, setLang, dark, setDark, funEn, setFunEn, funZh, setFunZh, narrator, t, adhd, setAdhd, vocabulary, setVocabulary, school, setSchool }: {
  ...
  const stored = storedTab.value === '' ? '' : (SETTINGS_SECTIONS as readonly string[]).includes(storedTab.value || '') ? storedTab.value as Section : 'appearance';
  ...
  return <div className="page-panel settings settings-workspace" data-ui="settings.workspace" ref={root}>
    ...
    <div className="settings-tabs">
      <TabStrip surface="settings" allIds={SETTINGS_SECTIONS} tabs={sections} active={active} onChange={value => { storedTab.setValue(value); setNavigationTarget(null); }} t={t} />
      <section id="settings-panel-appearance" role="tabpanel" aria-labelledby="tab-settings-appearance" hidden={active !== 'appearance'} className="settings-section">
        {findIn('appearance')}
      ...
      {!school.on && <section id="settings-panel-language" role="tabpanel" aria-labelledby="tab-settings-language" hidden={active !== 'language'} className="settings-section">
        {findIn('language')}
      ...
      <section id="settings-panel-comfort" role="tabpanel" aria-labelledby="tab-settings-comfort" hidden={active !== 'comfort'} className="settings-section">
        {findIn('comfort')}
      ...
      <section id="settings-panel-narrator" role="tabpanel" aria-labelledby="tab-settings-narrator" hidden={active !== 'narrator'} className="settings-section">
        {findIn('narrator')}
        <NarratorSettings narrator={narrator} t={t} />
      </section>
      <section id="settings-panel-privacy" role="tabpanel" aria-labelledby="tab-settings-privacy" hidden={active !== 'privacy'} className="settings-section">
        {findIn('privacy')}
