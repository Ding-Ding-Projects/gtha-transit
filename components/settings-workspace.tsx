...
export default function SettingsWorkspace({ appearance, lang, setLang, dark, setDark, funEn, setFunEn, funZh, setFunZh, narrator, t, adhd, setAdhd, vocabulary, setVocabulary, school, setSchool, historyBackend, onRestorePreferences, schedule }: {
