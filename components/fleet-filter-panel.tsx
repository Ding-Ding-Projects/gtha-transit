  ...
  return <details className="fleet-filter-panel" open={expanded}>
    ...
    <div className="fleet-filter-panel__content">
      ...
      <section aria-label={t('Propulsion filter', '推進方式篩選')} className="fleet-filter-electric">
        ...
        <label htmlFor="fleet-filter-electric" className="fleet-filter-electric-switch">
          <input id="fleet-filter-electric" role="switch" aria-checked={electricOnly} type="checkbox" checked={electricOnly} onChange={event => update({ propulsion: event.target.checked ? 'electric' : '' })} />
