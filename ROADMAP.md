...
- [x] Integrate or retire every outstanding branch and reduce the repository to one `main` locally and remotely, after archiving it. The linked checkpoint was preserved at `9a1d0ef`, proved ancestral to `main`, and its archived checkout is safe to retire.
