...
| City of Toronto | Nine Toronto Public Library branches | City branch-record receipts directly publish `PublicWashroom: "1"` and WGS84 coordinates. The current branch pages publish regular hours and dated closures or early closes. The two original records are Toronto Reference Library and High Park Library; seven additional records are listed below. |
...
## Additional Toronto library facilities

The following seven records use an exact City branch-record endpoint for public-washroom and coordinate evidence. Their live TPL pages supply the current weekly schedule and dated holiday exceptions. All are time-eligible only inside their published branch interval and outside an applicable dated exception. No record asserts a separate washroom-only schedule, fee, or unrestricted 24-hour access.

| Facility | Direct City record | Live TPL hours and exception source | Source-provided coordinates |
| --- | --- | --- | --- |
| Scarborough Civic Centre | [`SC`, `_id` 93](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22SC%22%7D) | [Scarborough Civic Centre](https://tpl.ca/locations/sc/) | `43.77237, -79.25704` |
| North York Central Library | [`CL`, `_id` 24](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22CL%22%7D) | [North York Central Library](https://tpl.ca/locations/cl/) | `43.76817, -79.41451` |
| Eatonville | [`EA`, `_id` 35](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22EA%22%7D) | [Eatonville](https://tpl.ca/locations/ea/) | `43.64616, -79.55910` |
| Richview | [`RI`, `_id` 88](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22RI%22%7D) | [Richview](https://tpl.ca/locations/ri/) | `43.68344, -79.54113` |
| Fort York | [`FO`, `_id` 41](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22FO%22%7D) | [Fort York](https://tpl.ca/locations/fo/) | `43.63923, -79.40039` |
| Parliament Street | [`PL`, `_id` 81](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22PL%22%7D) | [Parliament Street](https://tpl.ca/locations/pl/) | `43.66183, -79.36803` |
| Lillian H. Smith | [`LS`, `_id` 63](https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=7420a950-e62b-41da-826c-32d31c46e8f8&filters=%7B%22BranchCode%22%3A%22LS%22%7D) | [Lillian H. Smith](https://tpl.ca/locations/ls/) | `43.65798, -79.39839` |

Scarborough Civic Centre and Fort York state wheelchair-accessible washrooms on their live pages. The remaining entries retain `wheelchair: null` because a general accessibility label does not establish a washroom-specific claim.
