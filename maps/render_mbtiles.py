...
def main(src,target):
 ...
 for z in range(8,14):
  n=1<<z
  # Ontario bounding box, keeping generation regional instead of global.
  west,north,east,south=-95.2,57.2,-74.0,41.5
  ...
  for x in range(x0,x1):
   for y in range(y0,y1):
    ...
    for table,col,w in [('water',(167,205,224),2),('roads',(93,91,85),2)]:
     for (raw,) in db.execute(f'SELECT geometry FROM {table}'):
