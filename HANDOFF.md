...
Frontend: `f45bf93c55d1f57448de2f3e362613121c35c65f`, built `2026-09-05T11:05:15.77Z`, live at https://toronto-transit.org. Backend source: `b92de7c`. Public version and endpoint responses were independently checked. The graph remains `f4763bf444d82e922b892ff2a4dd3368176df4f308d63b7743617e7cc9c9e2b4`. Map revision remains `199cc9933f670a7fc1c33099a18891a53f5d187212c0041ce2b95ac6bafd381c`.
...
The washroom proxy POST repair is deployed and tested through the public domain. A fixed public-coordinate example near Yonge/Bloor to Union at Sep5 noon returned a complete facility-and-continuation response: ETA 2455 seconds, arrival `2026-09-05T12:40:55-04:00`, and departure after a planned ten-minute visit at `2026-09-05T16:50:55Z`. It uses published hours and does not claim live door or queue status. The method regression was deliberately reverted to reproduce 405, then restored to pass. Selected Eglinton platform `ttc:13795` independently exposes its official route and agency-qualified washroom with unknown hours.
...
Browser stop-badge selection remains unverified because no post-selection identity or response was retained. API enrichment is verified separately. Physical touch, spoken audio, live GPS progress, all vehicle-switching paths, drag reordering and public evidence promotion remain outstanding. Local checks: 138 root tests at the combined UI candidate, 57 backend tests at b92, 6 generator tests, and type checking passed. The later focused web-server suite has 5 passing tests. Workflow builds publish without running tests; a successful workflow is not runtime proof.
