...
The browser-based GTHA planner is live at https://toronto-transit.org, with the owner-managed tunnel and a private LAN fallback. Frontend commit `60194943b932ed0e0d5019dde73d121848165e4b` is deployed, with public version provenance built at `2026-09-05T06:06:08.206Z`. The routing API and graph promotion use `b5d510333045c719c4d845535e9e6f89ff3ef080`. Map dataset revision `199cc9933f670a7fc1c33099a18891a53f5d187212c0041ce2b95ac6bafd381c` was generated by renderer `fdd0ec2a716f17cc4380ee2096b2974e6703671b` and validated with `734a1899583c506cb9b97880eea77c29edd66a03`.
...
At frontend commit `6019494`, the root Node suite passes 44 tests. Type checking passed for the suggestion-state changes and the deployed production build passed. The route-catalog backend lane separately passed 14 tests at `9305377`; its generated index and API deployment are pending. The map-service suite separately passes four tests, renderer two tests, and candidate verifier three tests. Those Python results bind to their respective implementation commits; do not describe them as workflow tests.
